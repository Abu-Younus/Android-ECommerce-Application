...
public class CartItemModel {
    ...
    public CartItemModel(int type, String productID, String productImage, String productTitle, Long freeCoupons, String productPrice, String cuttedPrice, Long productQuantity, Long maxQuantity, Long stockQuantity, Long offersApplied, Long couponsApplied, boolean inStock, boolean COD) {
        this.type = type;
